    ...
    public class InputConverter : JsonConverter
    {
        ...
        private static object GetValue(object value)
        {
            ...
            if (objectValue != null)
            {
                ...
                foreach (var kvp in objectValue) output.Add(kvp.Key, GetValue(kvp.Value));
                return output;
            }
            ...
            {
                return new Dictionary<string, object> {{propertyValue.Name, GetValue(propertyValue.Value)}};
            }
